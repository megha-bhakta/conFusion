...
import { trigger, style, transition, state,animate, animation} from '@angular/animations';
...
export class DishdetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRouter.params.pipe(switchMap((params: Params) => { this.visibility='hidden'; return this.dishService.getDish(params['id'])}))
